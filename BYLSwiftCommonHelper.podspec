#
#  Be sure to run `pod spec lint BYLSwiftCommonHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ben LIU"
  # s.authors            = { "Ben LIU" => "arkilis@gmail.com" }
  ...
  # s.source_files  = "Classes", "Classes/**/*.{h,m}" # original
  s.source_files  = "BYLSwiftCommonHelper/Extensions/*.swift"
